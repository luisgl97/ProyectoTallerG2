<?php include_once 'includes/templates/header.php'; ?>
    ...
    <section class="seccion contenedor">
        ...
        <form id="registro" class="registro" action="validar_registro.php" method="post">
                ...
                <ul class="lista-precios clearfix">
                    <li>
                        <div class="tabla-precio">
                            ...
                            <p class="numero">$30</p>
                            <ul>
                                <li>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut a aut iusto corporis placeat, deleniti, molestias facere et perferendis consequuntur, at harum recusandae laudantium obcaecati aliquam voluptatem? Vitae, qui
                                    ratione.
                                </li>

                            </ul>
                            <div class="orden">
                                <label for="pase_dia">Boletos deseados(viernes):</label>
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <p class="numero">$50</p>
                            <ul>
                                <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure a perspiciatis fugit velit, corporis cum eligendi, suscipit doloremque voluptas molestias laborum, consequatur alias perferendis accusamus ex. Ut eaque odit
                                    omnis.
                                </li>
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                <label for="pase_dosdias">Boletos deseados(viernes y sabado):</label>
            ...
            <div id="cursos" class="eventos clearfix">
